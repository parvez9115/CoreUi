...
@Component({
  selector: 'app-esim-topup-details',
  templateUrl: './esim-topup-details.component.html',
  styleUrls: ['./esim-topup-details.component.scss'],
})
export class EsimTopupDetailsComponent {
  ...
  onGridReady() {
    ...
    var url = ServerUrl.live + '/esim/getTopupEsimHistoryDetails';
  ...
  ngOnInit() {
    this.pagePermission =
      this.permission.getPermissionDetails('Esim Topup Details');
  }
}
